...
parser.add_argument('--inputs_path', default = '/eos/user/m/mstamenk/CxAOD31run/hhh-6b/v25/2017/baseline_recomputedSF/gt1PFfat') # path of inputs after NanoNN  /eos/user/m/mstamenk/CxAOD31run/hhh-6b/v25/2017/inclusive
