...
hist_properties = {'JetHT' : [ROOT.kBlack, 0.8, 0, 'Data', True] , # [color, marker size, line size, legend label , add in legend]
                   ...
                   'SingleMuon' : [ROOT.kBlack, 0.8, 0, 'Data', True],
...
for year in ['2016APV','2016','2017','2018']:
    ...
    files_bkg = {}
    for bkg in ['QCD','ZJetsToQQ','WJetsToQQ','WWW','WZZ','ZZTo4Q', 'TT']:
    #for bkg in ['QCD6B']:
    ...
    for var_name in ['tot','pass']:
        ...
        h_data.SetStats(0)
        h_data.GetXaxis().SetTitle(labels['ht'])
        h_data.SetTitle('')
        #h_data.Sumw2()
        ...
        print(h_data.GetXaxis().GetNbins())
        ...
        #for bkg in ['QCD6B']:
            ...
            h_tmp = f_bkg.Get(var)
            #h_tmp.Sumw2()
            binining = binnings['ht']
            try:
                h_tmp.SetDirectory(0)
              
            except: continue
            #if 'QCD' in bkg and '2018' in year:
            #    h_tmp.Scale(2.93)
        ...
        h_div.GetYaxis().SetRangeUser(0.1,4.)
