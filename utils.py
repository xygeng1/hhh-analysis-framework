...
#
#    reader->BookMVA("BDT","/isilon/data/users/mstamenk/hhh-6b-producer/CMSSW_11_1_0_pre5_PY3/src/hhh-plotting/data/TMVAClassification_BDT_inclusive_2017_optimal.weights.xml");
#
...
#    ''')
    ...
    #df = df.Define('BDT', "computeBDTScore(rdfslot_, h_fit_mass, h1_t3_mass, h2_t3_mass, h3_t3_mass, h1_t3_dRjets, h2_t3_dRjets, h3_t3_dRjets, bcand1Pt, bcand2Pt, bcand3Pt, bcand4Pt,bcand5Pt, bcand6Pt, bcand1Eta, bcand2Eta, bcand3Eta, bcand4Eta, bcand5Eta, bcand6Eta, bcand1DeepFlavB, bcand2DeepFlavB, bcand3DeepFlavB, bcand4DeepFlavB, bcand5DeepFlavB, bcand6DeepFlavB,fatJet1Mass,fatJet1Pt,fatJet1Eta,fatJet1PNetXbb,fatJet2Mass,fatJet2Pt,fatJet2Eta,fatJet2PNetXbb,fatJet3Mass,fatJet3Pt,fatJet3Eta,fatJet3PNetXbb)")
    #l_varn = ROOT.std.vector('std::string')()
    #l_varn.push_back('rdfslot_')
    #for el in ["h_fit_mass"," h1_t3_mass"," h2_t3_mass"," h3_t3_mass"," h1_t3_dR    jets"," h2_t3_dRjets"," h3_t3_dRjets"," bcand1Pt"," bcand2Pt"," bcand3Pt"," bcand4Pt","bcand5Pt"," bcand6Pt"," bcand1Eta"," b    cand2Eta"," bcand3Eta"," bcand4Eta"," bcand5Eta"," bcand6Eta"," bcand1DeepFlavB"," bcand2DeepFlavB"," bcand3DeepFlavB","     bcand4DeepFlavB"," bcand5DeepFlavB"," bcand6DeepFlavB","fatJet1Mass","fatJet1Pt","fatJet1Eta","fatJet1PNetXbb","fatJet2    Mass","fatJet2Pt","fatJet2Eta","fatJet2PNetXbb","fatJet3Mass","fatJet3Pt","fatJet3Eta","fatJet3PNetXbb"]:
    #    l_varn.push_back(el)
   # print(df.Count().GetValue())
    #df = df.DefineSlot('BDT', ROOT.computeBDTScore, l_varn)
#    return df
