...
for cat in ['%s_0bh0h_inclusive','%s_2Higgs_inclusive','%s_1Higgs_inclusive','%s_3Higgs_inclusive','%s_3bh0h_inclusive','%s_2bh1h_inclusive','%s_1bh2h_inclusive','%s_0bh3h_inclusive']:# variables:
# for cat in ['%s_1bh2h_inclusive','%s_0bh3h_inclusive']:# variables:
# for cat in ['%s_0bh0h_inclusive']:# variables:
    cat = cat%prob
    print(cat)
    #print(binnings[cat])
    target = '%s%s/histograms/kappa'%(cat,option)
    ...
    # samples=["GluGluToHHTo4B_cHHH1","GluGluToHHTo4B_cHHH0","GluGluToHHTo4B_cHHH5","data_obs","GluGluToHHHTo6B_SM","GluGluToHHHTo4B2Tau_SM","GluGluToHHTo2B2Tau_SM","QCD_datadriven"]
    samples = ['HHHTo6B_c3_0_d4_99','HHHTo6B_c3_0_d4_minus1','HHHTo6B_c3_19_d4_19','HHHTo6B_c3_1_d4_0','HHHTo6B_c3_1_d4_2','HHHTo6B_c3_2_d4_minus1','HHHTo6B_c3_4_d4_9','HHHTo6B_c3_minus1_d4_0','HHHTo6B_c3_minus1_d4_minus1','HHHTo6B_c3_minus1p5_d4_minus0p5']

    # samples=["data_obs","QCD_datadriven_data"]

    #samples = ['GluGluToHHHTo6B_SM']

    var_HHH = "ProbMultiH" #variables[cat]
