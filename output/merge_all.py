...
for bdt_cut in bdt_cut_strings:
    for btag_cut in btag_cut_strings:
        output_folder = "{}/run2/{}/{}/histograms".format(path,bdt_cut,btag_cut)

        output_folder1 = "{}/run/".format(path)
        ...
        output_folder2 = "{}/run/{}/".format(path,bdt_cut)
        ...
        output_folder3 = "{}/run/{}/{}".format(path,bdt_cut,btag_cut)
        ...
        for process in process_strings:
            os.system("hadd -f  %s/run2/%s/%s/%s.root  %s/2016/%s/%s/%s.root  %s/2016APV/%s/%s/%s.root  %s/2017/%s/%s/%s.root  %s/2018/%s/%s/%s.root"%(path,bdt_cut,btag_cut,process,path,bdt_cut,btag_cut,process,path,bdt_cut,btag_cut,process,path2,bdt_cut,btag_cut,process,path2,bdt_cut,btag_cut,process)) 
