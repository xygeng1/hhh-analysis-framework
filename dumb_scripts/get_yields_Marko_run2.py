...
for cat in cat_list:
    ...
    for sample in sample_list:
        path = "/eos/user/x/xgeng/workspace/HHH/CMSSW_12_5_2/src/hhh-analysis-framework/output/v33/Marko_sample_1Higgs/Prob%s_inclusive_CR/histograms"%(cat)
        file_kappa=ROOT.TFile("%s/histograms_ProbMultiH_fixAsy.root"%(path), "READ")
        hist = file_kappa.Get(sample)
